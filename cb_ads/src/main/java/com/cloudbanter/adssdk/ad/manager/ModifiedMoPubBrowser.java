...
public class ModifiedMoPubBrowser extends Activity {
  public static final String TAG = ModifiedMoPubBrowser.class.getSimpleName();
  ...
  private void initializeWebView() {
    ...
    Log.d(TAG, "Url: " + getIntent().getStringExtra(DESTINATION_URL_KEY));

    mWebView.loadUrl(getIntent().getStringExtra(DESTINATION_URL_KEY));

    mWebView.setWebViewClient(new ModifiedBrowserWebViewClient(this));
  ...
  private void initializeButtons() {
    ...
    mCloseButton.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        ModifiedMoPubBrowser.this.finish();
      }
    });
  }
  ...
  protected void onDestroy() {
    ...
    MoPubEvents.log(new Event.Builder(BaseEvent.Name.AD_DWELL_TIME,
            BaseEvent.Category.AD_INTERACTIONS,
            BaseEvent.SamplingRate.AD_INTERACTIONS.getSamplingRate())
  ...
  private View getMoPubBrowserView() {
    ...
    LinearLayout.LayoutParams browserLayoutParams =
    ...
    LinearLayout.LayoutParams outerLayoutParams =
    ...
    RelativeLayout.LayoutParams innerLayoutParams =
            new RelativeLayout.LayoutParams(MATCH_PARENT, WRAP_CONTENT);
  ...
  private ImageButton getButton(final Drawable drawable) {
    ...
    LinearLayout.LayoutParams layoutParams =
            new LinearLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT, 1f);
