...
class ModifiedBrowserWebViewClient extends WebViewClient {
  public static final String TAG = ModifiedBrowserWebViewClient.class.getSimpleName();
  ...
  @NonNull
  private ModifiedMoPubBrowser mMoPubBrowser;

  public ModifiedBrowserWebViewClient(@NonNull final ModifiedMoPubBrowser moPubBrowser) {
    Log.d(TAG, "Creating modified browser");
  ...
  public void onReceivedError(WebView view, int errorCode, String description,
                              String failingUrl) {
    Log.d(TAG, "MoPubBrowser error: " + description);
  }

  @Override
  public boolean shouldOverrideUrlLoading(WebView view, String url) {
    Log.d(TAG, "Should override called for url: " + url);
